...
exports.clauseStructurePass = clauseStructurePass;
const utils_1 = require("../utils");
// This pass ensures that major SQL clauses start on their own lines
function clauseStructurePass(text, opts) {
    ...
    const indented = (0, utils_1.lines)(result).map((line) => {
    ...
    return (0, utils_1.rejoin)(indented);
}
//# sourceMappingURL=01-clause-structure.js.map
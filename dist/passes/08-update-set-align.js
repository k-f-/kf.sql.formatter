...
exports.updateSetAlignPass = updateSetAlignPass;
const utils_1 = require("../utils");
function updateSetAlignPass(text, _opts) {
    ...
    const flush = () => {
        ...
        const pairs = block.map((ln) => {
            ...
            if (idx < 0)
                return { lhs: ln, rhs: '', raw: ln, hasEq: false };
...
//# sourceMappingURL=08-update-set-align.js.map
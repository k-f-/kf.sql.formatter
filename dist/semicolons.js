...
exports.normalizeSemicolons = normalizeSemicolons;
function normalizeSemicolons(text, opts) {
    ...
    const flushBuffer = () => {
        ...
        if (statementCount === 0) {
            ...
            const firstLineIndex = buffer.findIndex(line => !opts.skipCommentLines || !line.trim().startsWith('--'));
            if (firstLineIndex >= 0) {

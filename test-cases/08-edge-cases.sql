...
from t
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        -- TC8.6: Unicode and special characters in identifiers
;
select
...
from users
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        -- TC8.9: Extremely long single line
;
select
  id, name, email, phone, address, city, state, zipcode, country, created_at, updated_at, status, type, category, subcategory, description, notes, metadata, tags, preferences, settings
...
where	status	=	'active'
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        -- TC8.11: Consecutive semicolons
;
select
  id
from t1;

                                                                                                                                                                                                                                                                                        -- TC8.12: No semicolon at END
;
select
  id
from t2

                                                                                                                                                                                                                                                                                        -- TC8.13: Multiple statements
;
